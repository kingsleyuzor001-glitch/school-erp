      ...
      links={[
        {
          ...
          to: "/staff/attendance",
          description: "Clock in and clock out for your workday."
        },
        {
          label: "Attendance",
        ...
        },
        {
          label: "Results Entry",
          to: "/teacher/results",
          description: "Enter and submit scores for approval."
        },
        {
          label: "Lesson Notes",
          to: "/teacher/lesson-notes",
          description: "Upload and browse lesson notes."
        },
        {
          label: "Announcements",
          to: "/announcements",
