...
import AcademicSessionsPage from "./pages/super-admin/AcademicSessionsPage";
import AcademicTermsPage from "./pages/super-admin/AcademicTermsPage";
...
import TeacherAssignmentsPage from "./pages/school-admin/TeacherAssignmentsPage";
...
<Route path="/super-admin/sessions" element={<AcademicSessionsPage />} />
<Route path="/super-admin/terms" element={<AcademicTermsPage />} />
        </Route>
      </Route>
      ...
      <Route element={<ProtectedRoute allowed={["school_owner", "school_admin"]} />}>
        <Route element={<AppLayout />}>
          ...
          <Route path="/school-admin/teacher-assignments" element={<TeacherAssignmentsPage />} />
